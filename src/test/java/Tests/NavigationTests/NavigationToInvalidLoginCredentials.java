...
public class NavigationToInvalidLoginCredentials extends TestBase {
//Created in here - cause our test should be quicker and we want to test only functionality of Login form - so no need for navigation
    @Test
